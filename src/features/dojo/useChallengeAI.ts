...
Requirements:
1. Write a correct function (10-15 lines)
2. Introduce 2-3 subtle bugs:
   - Logic errors (off-by-one, wrong operator)
   - Missing null/edge case checks
   - Performance issues
3. Make bugs realistic but findable
...
Return ONLY valid JSON:
{
  ...
  "bugs": [
    {"lineNumber": 5, "bugType": "logic", "description": "What's wrong", "hint": "Hint", "fix": "The fix"}
  ]
}`,
