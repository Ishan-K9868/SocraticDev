...
function MentalCompiler({
    ...
    useEffect(() => {
        const loadChallenge = async () => {
            const generated = await generateMentalChallenge(topic, language);
            if (generated) {
                setChallenge(generated);
            }
        };
        loadChallenge();
    }, [topic, language, generateMentalChallenge]);
        ...
        <div className="min-h-screen bg-[color:var(--color-bg-primary)] p-6">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    {/* Answer Options */}
                    <div>
                        <h3 className="font-semibold mb-3">🎯 What's the output?</h3>
