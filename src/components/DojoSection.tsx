...
const BENEFITS = [
    { icon: '🎯', title: 'Active Recall', description: 'Learn by doing, not just reading. Each challenge forces you to actively engage with concepts.' },
    { icon: '🧠', title: 'Deliberate Practice', description: 'Targeted exercises that push your skills just beyond your comfort zone.' },
    { icon: '📊', title: 'Track Progress', description: 'Watch your skills grow with points, streaks, and earned badges.' },
    { icon: '⚡', title: 'Instant Feedback', description: 'Know immediately what you got right and learn from mistakes in real-time.' },
];
